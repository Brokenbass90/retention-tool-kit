...
// import { replacePlaceholders } from './utils/replacePlaceholders'; // путь к файлу с функцией
// const App = observer(() => {
//   const [buttonColors, setButtonColors] = useState({});
//   const [isModalOpen, setIsModalOpen] = useState(false);
//   const [isConfiguratorOpen, setIsConfiguratorOpen] = useState(false);
...
//         }
//     });
//     // Применяем стили текущего бренда, если он выбран
//     if (currentBrand) {
//       const placeholders = {
//         '{%brand_color%}': currentBrand.styles.brand_color,
//         // Другие placeholders
//       };
//       for (const [placeholder, value] of Object.entries(placeholders)) {
//         if (value) {
...
//     const placeholders = {
//       '{%brand_color%}': currentBrand.styles.brand_color,
//       '{%brand_additional_color%}': currentBrand.styles.brand_additional_color,
//       '{%on_brand_color%}': currentBrand.styles.on_brand_color,
//       '{%surface_color%}': currentBrand.styles.surface_color,
//       '{%surface_variant_color%}': currentBrand.styles.surface_variant_color,
//       '{%on_surface_color%}': currentBrand.styles.on_surface_color,
//       '{%background_color%}': currentBrand.styles.background_color,
//       '{%accent_color%}': currentBrand.styles.accent_color,
//       '{%button_radius%}': currentBrand.styles.button_radius,
//       '{%small_radius%}': currentBrand.styles.small_radius,
//       '{%large_radius%}': currentBrand.styles.large_radius,
//       '{%logo_email_brand%}': currentBrand.styles.logo_email_brand,
//       '{%padding_l%}': currentBrand.styles.padding_l,
//       '{%padding_m%}': currentBrand.styles.padding_m,
//       '{%padding_s%}': currentBrand.styles.padding_s,
//       '{%padding_xs%}': currentBrand.styles.padding_xs,
//     };
//     for (const [placeholder, value] of Object.entries(placeholders)) {
//       if (value) {
//         updatedHtml = updatedHtml.replace(new RegExp(placeholder, 'g'), value);
...
//       '{%padding_xs%}': brand.styles.padding_xs,
//   };
//   let updatedHtml = appStore.html;
//     for (const [placeholder, value] of Object.entries(placeholders)) {
//         if (value) {
//             updatedHtml = updatedHtml.replace(new RegExp(placeholder, 'g'), value);
//         }
//     }
//     setCurrentBrand(brand); // Сохраняем текущий бренд
//     runInAction(() => {
//         appStore.html = updatedHtml;
//     });
// };
...
//           className={`original-btn ${appStore.isOriginalSelected ? 'selected' : ''}`}
//           onClick={() => {
//             handleRestoreOriginal();  // Вызов сброса локалей
//             appStore.isOriginalSelected = true;
//             appStore.selectedLocale = '';
//           }}
//         >
...
//             <button 
//               onClick={() => {
//                 handleLocaleSelection(locale);  // Вызов правильной функции
//                 appStore.isOriginalSelected = false;
//               }} 
//               className={`locale-btn ${appStore.selectedLocale === locale && !appStore.isOriginalSelected ? 'selected' : ''}`}
//             >
